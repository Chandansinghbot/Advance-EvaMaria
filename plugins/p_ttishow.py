...
async def save_group(bot, message):
    ...
    if temp.ME in r_j_check:
        ...
        if message.chat.id in temp.BANNED_CHATS:
            ...
            buttons = [[
                InlineKeyboardButton('🌐 Support', url=f'https://t.me/bollywoodsouthhindimovieswebse')
            ]]
        ...
        buttons = [[
            ...
            InlineKeyboardButton('📢 Updates', url='https://t.me/bollywoodsouthhindimovieswebse')
        ]]
        reply_markup=InlineKeyboardMarkup(buttons)
